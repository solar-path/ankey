...
import OffersPage from "./routes/offers.page";
...
function App() {
  ...
  const isPublicRoute = !isKnownRoute || publicRoutes.some(route => {
    if (location === route) return true;
    if (location.startsWith(route + "?")) return true;
    return false;
  });
        ...
        {isPublicRoute ? (
          <PublicLayout>
            <Switch>
              ...
              <Route path="/auth/verify-account" component={VerifyAccountPage} />
