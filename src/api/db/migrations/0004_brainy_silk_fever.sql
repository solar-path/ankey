...
ALTER TABLE "core_user_roles" ADD CONSTRAINT "core_user_roles_assigned_by_core_users_id_fk" FOREIGN KEY ("assigned_by") REFERENCES "public"."core_users"("id") ON DELETE no action ON UPDATE no action;