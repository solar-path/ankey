...
export function DOAMatrixForm({ companyId, matrix, onSuccess, onCancel }: DOAMatrixFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      effectiveFrom: matrix?.effectiveFrom ? new Date(matrix.effectiveFrom).toISOString() : undefined,
      effectiveTo: matrix?.effectiveTo ? new Date(matrix.effectiveTo).toISOString() : undefined,
