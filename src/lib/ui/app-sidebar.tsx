...
export function AppSidebar({ user, organization, ...props }: AppSidebarProps) {
  ...
  React.useEffect(() => {
    console.log(
      "[AppSidebar] Re-render - passing companies:",
      companies.length,
      "to TeamSwitcher"
    );
  ...
  const getFilePathFromRoute = (route: string): string => {
    ...
    if (route.startsWith("/auth/signin"))
      return "src/routes/public/auth/signin/signIn.page.tsx";
    if (route.startsWith("/auth/signup"))
      return "src/routes/public/auth/signup/signUp.page.tsx";
    if (route.startsWith("/auth/forgot-password"))
      return "src/routes/public/auth/forgot-password/forgotPassword.page.tsx";
    if (route.startsWith("/auth/verify-account"))
      return "src/routes/public/auth/verify-account/verifyAccount.page.tsx";
    if (route.startsWith("/learn")) return "src/routes/public/learn.page.tsx";
    if (route.startsWith("/contact"))
      return "src/routes/public/contactUs.page.tsx";
    if (route.startsWith("/offers")) return "src/routes/public/offers.page.tsx";
    if (route.startsWith("/public/job-offer/"))
      return "src/routes/public/jobOfferAccept.page.tsx";
    if (route.startsWith("/dashboard"))
      return "src/routes/private/dashboard/company.dashboard.page.tsx";
    if (route.startsWith("/account"))
      return "src/routes/private/account/account.page.tsx";
    if (route.startsWith("/task/") && route.split("/").length === 3)
      return "src/routes/private/tasks/taskDetail.page.tsx";
    if (route.startsWith("/task"))
      return "src/routes/private/tasks/tasks.page.tsx";
    if (route.startsWith("/settings"))
      return "src/routes/private/settings/settings.page.tsx";
    if (route.startsWith("/company/"))
      return "src/routes/private/company/company.page.tsx";
    if (route.startsWith("/orgchart/detail/"))
      return "src/routes/private/htr/overview/orgchartDetail.page.tsx";
    if (route.match(/^\/orgchart\/[^/]+\/assignment\//))
      return "src/routes/private/htr/assignments/assignmentDetail.page.tsx";
    if (route.startsWith("/orgchart/"))
      return "src/routes/private/htr/overview/orgchart.page.tsx";
    if (route.match(/^\/doa\/[^/]+\/matrix\//))
      return "src/routes/private/doa/doaDetail.page.tsx";
    if (route.startsWith("/doa/")) return "src/routes/private/doa/doa.page.tsx";
    if (route.startsWith("/documents"))
      return "src/routes/private/documents/documents.page.tsx";
    if (route.startsWith("/job-offers"))
      return "src/routes/private/htr/job-offers/jobOffers.page.tsx";
    if (route.startsWith("/job-offer/"))
      return "src/routes/private/htr/job-offers/jobOfferDetail.page.tsx";
    if (route.startsWith("/users/invite"))
      return "src/routes/private/user-management/invite.user.page.tsx";
    if (route.startsWith("/users/"))
      return "src/routes/private/user-management/invite.user.page.tsx";
    if (route.startsWith("/users"))
      return "src/routes/private/user-management/users.page.tsx";
  ...
  return (
    <Sidebar collapsible="icon" {...props} className="bg-stone-50">
      <SidebarHeader>
        ...
        <TeamSwitcher
          key={`team-switcher-${companies.length}-${
            activeCompany?._id || "none"
          }`}
          companies={companies}
        />
      </SidebarHeader>
